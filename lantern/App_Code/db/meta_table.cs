...
namespace deeper.db
{
  public class meta_table
  {
    ...
    string _name, _title, _single, _row_title_field, _row_notes_field, _fields_info;
    ...
    public meta_table(string name, string title, string single, string fields_info, string row_title_field, string row_notes_field
      , meta_doc.table_type type, XmlNode nd, IEnumerable<meta_rule> rules = null, IEnumerable<meta_link> links = null, string rec_code = ""
      , bool is_enum = false) {
      _name = name; _title = title; _single = single; _type = type;
      _row_title_field = row_title_field; _row_notes_field = row_notes_field;
    ...
    public string row_title_field { get { return _row_title_field; } }
    public string row_notes_field { get { return _row_notes_field; } }
    ...
    public string attr(string name_attr) { return deeper.lib.xmlDoc.node_val(_node, name_attr); }
