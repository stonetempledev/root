...
<asp:Content ContentPlaceHolderID="contents" runat="Server">
    <div class='container'>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3 fs-120">
                <div class='badge badge-primary'>
                    <%--<span contenteditable fld='evento'>Evento primordiale</span>--%>
                    <input type="text" style="background-color: transparent; border: none; font-weight: 700; line-height: 1; color:white;" fld="evento" value="Evento primordiale" />
                    <span>dal 5 Agosto 2015 al 10 Agosto 2030</span>
                </div>
            </div>
