...
namespace toyn {
  public class child {
    ...
    public enum content_type { element, title, text, value, account }
    ...
    public child(element el, content_type tp, int child_id) { this.element = el; this.type = tp; this.id = child_id; }
