  ...
  (global.metisMenu = factory(global.jQuery));
    ...
    var MetisMenu = function ($$$1) {
        ...
        var Default = {
            ...
            //triggerElement: 'span.mm-arrow',
            triggerElement: 'div.mm-circle-arr',
            parentTrigger: 'li',
            subMenu: 'ul'
        };
        var Event = {
    ...
    function () {
        ...
        _proto.init = function init() {
            ...
            $$$1(this.element).find(conf.parentTrigger).has(conf.subMenu).find(conf.triggerElement).on(Event.CLICK_DATA_API, function (e) {

                //alert(JSON.stringify(e));

                // eslint-disable-line func-names
                var eTar = $$$1(this);
                var paRent = eTar.parent().parent(conf.parentTrigger);
                var sibLings = paRent.siblings(conf.parentTrigger).find(conf.triggerElement);
        ...
        _proto.show = function show(element) {
            ...
            //            try {
            //                var href = $(element).parent().find("a[vmenu=true]:first").attr("href");
            //                if (href) { if (is_url(href)) window.location = href; else eval(href); }
            //            } catch (e) { }
        };
        ...
        _proto.dispose = function dispose() {
            ...
            $$$1(this.element).find(this.config.parentTrigger).has(this.config.subMenu).find(this.config.triggerElement).off('click');
            this.transitioning = null;
            this.config = null;
            this.element = null;
        };
