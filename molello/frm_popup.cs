...
namespace molello {
  public partial class frm_popup : frm_base {
    ...
    public static void show_msg (string title, string msg) { (new frm_popup(title, msg, Color.LightBlue)).ShowDialog(); }
    public static void show_error (string title, string msg) { (new frm_popup(title, msg, Color.Tomato)).ShowDialog(); }
    public static void show_error (string msg) { (new frm_popup("ERRORE!", msg, Color.Tomato)).ShowDialog(); }
